...
const preTimerElement = document.querySelector('.pre-timer');
...
quoteInputElement.addEventListener('input', () => {
    ...
    arrayQuote.forEach((characterSpan, index) => {
        ...
        if (character == null) {
            ...
            characterSpan.classList.remove('incorrext');
            correct = false;
        }
    ...
    console.log(arrayValue.join("").split(" "));
    console.log(arrayValue.join("").split(" ").length);

    accuracy = Math.round(((arrayValue.length - errors) / arrayValue.length) * 100);
    cpm = Math.round(arrayValue.length / (getTimerTime() / 60));
    wpm = Math.round(arrayValue.join("").split(" ").length / (getTimerTime() / 60));
    // console.log(errors);
    ...
    if(correct) {
        console.log("It took you" + getTimerTime() + " seconds to type the paragraph");
        completedElement.innerText = "Test completed, your time was " + getTimerTime() + " s";
...
function renderNewQuote() {
    const quote = paragraphs[Math.floor(Math.random() * paragraphs.length)];
    quoteInputElement.disabled = true;
    ...
    preTimerElement.innerText = "Test starting in " + "5" + " ....";

    setInterval(() => {
        countdown--;
        preTimerElement.innerText = "Test starting in " + countdown + " ....";
    }, 1000);
    setTimeout(() => {
...
// let copyTextArray = copyText.split('');
// let userTextLetterArray;

// // console.log(copyText);
// let i = -1;
// function processCurrentText() {
//     userTextLetterArray = document.querySelector('#usertext').value.split('');
//     console.log(userTextLetterArray);
//     i++;
//     console.log(i);
//     console.log(userTextLetterArray[userTextLetterArray.length - 1]);
    
//     if (userTextLetterArray[userTextLetterArray - 1] === copyTextArray[i]) {
//         console.log("you typed " + userTextLetterArray[userTextLetterArray.length - 1] + ", the correct text was " + copyTextArray[i] + ". It is correct");
//     }
//     else {
//         console.log("you typed " + userTextLetterArray[userTextLetterArray.length - 1] + ", the correct text was " + copyTextArray[i] + ". It is wrong");
//     }
// }
